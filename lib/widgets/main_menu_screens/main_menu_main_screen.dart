...
import 'main_menu_cash_screen/main_menu_cloudtips_screen.dart';
...
class _MainMenuMainScreenWidgetState extends State<MainMenuMainScreenWidget> {
  final _mainScreens = [
    ...
    {
      'widget': const MainMenuCloudtipsScreenWidget(),
      'title': 'Поддержать',
      'icon': Image.asset(
        ...
        child: CustomNavigationBar(
          ...
          items: [
            ...
            CustomNavigationBarItem(
              icon: Image.asset(
                'assets/images/money.png',
                color: _currentIndex == 5 ? Colors.white : Colors.white.withOpacity(0.5),
              ),
